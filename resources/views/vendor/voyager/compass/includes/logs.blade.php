...
<div class="col-sm-9 col-md-9 table-container">
  ...
  @else
    <table id="table-log" class="table table-striped" style="table-layout: fixed; width: 100%">
      <thead>
      <tr>
        <th style="width: 40px" >{{ __('voyager::compass.logs.level') }}</th>
        <th style="width: 60px">{{ __('voyager::compass.logs.context') }}</th>
        <th style="width: 60px">{{ __('voyager::compass.logs.date') }}</th>
